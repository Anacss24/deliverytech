...
//     @Query("SELECT p FROM Pedido p WHERE p.dataPedido >= :inicioDoDia AND p.dataPedido < :fimDoDia ORDER BY p.dataPedido DESC")
// List<Pedido> findPedidosDoDia(OffsetDateTime inicioDoDia, OffsetDateTime fimDoDia); 
